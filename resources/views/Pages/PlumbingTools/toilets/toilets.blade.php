            ...
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="list-inline-item"><span>||</span>Toilets</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="grid" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Toilets/toilet.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Toilets/toilet2.png')}}"
                                                alt="">
                                            <div class="layer-box">
                                        ...
                                        <div class="tab-heading">
                                            <p><a href="">Toilets and Urinals</a></p>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        ...
                                        <div class="tab-heading">
                                            <p><a href="">Toilet and Urinals</a></p>
                                        </div>
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                <ul class="list-unstyled list-inline fav">
