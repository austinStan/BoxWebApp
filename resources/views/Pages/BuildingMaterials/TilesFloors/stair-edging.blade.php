        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="">Home</a></li>
                        <li class="list-inline-item"><span>||</span><a href="">Floor & Tiles</a></li>
                        <li class="list-inline-item"><span>||</span>Stair-Edging</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="grid" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/TilesFloors/stair-edge.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/TilesFloors/stair-edge.png')}}"
                                                alt="">
                                            <div class="layer-box">
