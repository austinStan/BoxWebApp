        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="">Home</a></li>
                        <li class="list-inline-item"><span>||</span><a href="">Bricks</a></li>
                        <li class="list-inline-item"><span>||</span>Fire Bricks</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="grid" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Bricks/fbricks.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('mages/Bricks/fbricks.png')}}"
                                                alt="">
                                            <div class="layer-box">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Bricks/fbricks.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Bricks/fbricks.png')}}"
                                                alt="">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 55,000</li>
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                <div class="tab-img">
                                                    <img class="main-img img-fluid"
                                                        src="{{asset('images/Bricks/fbricks.png')}}" alt="">
