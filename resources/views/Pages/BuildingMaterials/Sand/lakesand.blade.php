        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="">Home</a></li>
                        <li class="list-inline-item"><span>||</span><a href="">Sand</a></li>
                        <li class="list-inline-item"><span>||</span>Lake Sand</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="grid" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/BuildingMaterials/Sand/Lake/lake.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/BuildingMaterials/Sand/Lake/lake.png')}}"
                                                alt="">
                                            <div class="layer-box">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline price">
                                                    ...
                                                    <li class="list-inline-item">UGX 350,000</li>
                                                </ul>
                                            </div>
                                            <div>
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline price">
                                                    <li class="list-inline-item">UGX 300000</li>
                                                    <li class="list-inline-item">UGX 350000</li>
                                                </ul>
                                            </div>
                                            <div>
                                                <a href="" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline price">
                                                    <li class="list-inline-item">UGX 200,000</li>
                                                    <li class="list-inline-item">UGX 260,000</li>
                                                </ul>
                                            </div>
                                            <div>
                                                <a href="" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline price">
                                                    <li class="list-inline-item">UGX 390,000</li>
