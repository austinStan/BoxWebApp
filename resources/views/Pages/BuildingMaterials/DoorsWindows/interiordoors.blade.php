        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="">Home</a></li>
                        <li class="list-inline-item"><span>||</span><a href="">Doors & Windows</a></li>
                        <li class="list-inline-item"><span>||</span>Interior Doors</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid"
                                                src="{{asset('images/DoorsWindows/interior-door.png')}}" alt="">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid"
                                                src="{{asset('images/DoorsWindows/interior-door2.png')}}" alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/DoorsWindows/interior-door.png')}}"
                                                alt="">
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 100,000</li>
