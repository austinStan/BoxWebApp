...
@section('title', 'Electricals and Wirings')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="">Home</a></li>
                        <li class="list-inline-item"><span>||</span><a href="">Electricals and Wirings</a></li>
                        <li class="list-inline-item"><span>||</span>Garden Lightings</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="grid" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Electricals/garden1.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Electricals/garden2.png')}}"
                                                alt="">
                                            <div class="layer-box">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline ">
                                                    <li class="list-inline-item">UGX 240,000</li>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Electricals/garden2.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Electricals/garden1.png')}}"
                                                alt="">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline ">
                                                    <li class="list-inline-item">UGX 150,000</li>
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline ">
                                                    <li class="list-inline-item">UGX 340,000</li>
                                                </ul>
                                            </div>
                                            <div>
                                                <a href="" data-toggle="tooltip" data-placement="top"
