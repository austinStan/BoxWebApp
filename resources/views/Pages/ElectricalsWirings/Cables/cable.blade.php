...
@section('title', 'Electricals and Wiring')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="">Home</a></li>
                        <li class="list-inline-item"><span>||</span><a href="">Electricals and Wiring</a></li>
                        <li class="list-inline-item"><span>||</span>Cables</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="grid" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Electricals/cable1.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Electricals/cable2.png')}}"
                                                alt="">
                                            <div class="layer-box">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline ">
                                                    <li class="list-inline-item">UGX 40,000</li>
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline ">
                                                    <li class="list-inline-item">UGX 50,000</li>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Electricals/cable2.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Electricals/cable1.png')}}"
                                                alt="">
                                            <div class="layer-box">
                                                <a href="" class="it-comp" data-toggle="tooltip" data-placement="left"
                                                    title="Compare"><img src="{{asset('images/it-comp.png')}}"
