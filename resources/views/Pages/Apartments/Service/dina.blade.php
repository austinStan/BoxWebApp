        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item"><a href="">Home</a></li>
                        <li class="list-inline-item"><span>||</span><a href="">Apartments</a></li>
                        <li class="list-inline-item"><span>||</span>Service Apartments</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="add-box">
                    <a href=""><img src="{{asset('images/banners/box-banner.png')}}" alt="" class="img-fluid"></a>
                </div>
            </div>
            <div class="col-md-9">
                            ...
                            <div class="row">
                                    ...
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid"
                                                src="{{asset('images/Apartments/dina.png')}}" alt="">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 800,000 ,2bedrooms</li>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid"
                                                src="{{asset('images/Apartments/dina2.png')}}" alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Apartments/dina2.png')}}"
                                                alt="">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 900,000 ,3bedrooms</li>
                                                    {{-- <li class="list-inline-item">UGX 250,000</li> --}}
                                                </ul>
                                            </div>
                                            <div>
                                                <a href="" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 900,000 ,4bedrooms</li>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid"
                                                src="{{asset('images/Apartments/dina.png')}}" alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Apartments/dina.png')}}"
                                                alt="">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 900,000 2bedrooms</li>
                                                    {{-- <li class="list-inline-item">UGX 300,000</li> --}}
                                                </ul>
                                            </div>
                                            <div>
                                                <a href="" data-toggle="tooltip" data-placement="top"
