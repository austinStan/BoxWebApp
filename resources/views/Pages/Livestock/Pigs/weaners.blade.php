            ...
            <div class="col-md-12">
                <div class="breadcrumb-box text-center">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="list-inline-item"><span>||</span>Pigs</li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid"
                                                src="{{asset('images/Cattle/weaners.png')}}" alt="">
                                        ...
                                        <div class="tab-heading">
                                            <p><a href="">Weaners Pig Breed</a></p>
                                        </div>
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 130,000</li>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid"
                                                src="{{asset('images/Cattle/weaners.png')}}" alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Cattle/weaners.png')}}"
                                                alt="">
                                    ...
                                    <div class="tab-item">
                                        ...
                                        <div class="img-content d-flex justify-content-between">
                                            <div>
                                                ...
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">UGX 70,000</li>
                                                    {{-- <li class="list-inline-item">UGX 300,000</li> --}}
                                                </ul>
                                            </div>
                                            <div>
