                        ...
                        <div class="tab-pane fade show active" id="grid" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="tab-item">
                                        <div class="tab-img">
                                            <img class="main-img img-fluid" src="{{asset('images/Houses/wakiso.png')}}"
                                                alt="">
                                            <img class="sec-img img-fluid" src="{{asset('images/Land/wakiso.png')}}"
                                                alt="">
                                            <div class="layer-box">
